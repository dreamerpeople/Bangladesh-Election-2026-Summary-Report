...
<head>
    ...
    animation: slideDown 0.3s ease;
        ...
        table {
            ...
            background: white;
            min-width: 1200px; /* Ensure table maintains minimum width */
        }
        ...
        .header{    padding: 20px 10px;}
            ...
            .simulation-intro{text-align: center; font-size: 1em;}
...
<body>
            ...
            <div class="party-section">
               ...
               <!-- <div class="party-logo-header">
                ...
                <div class="scroll-hint" id="scrollHint">
                    Scroll horizontally to see more <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                </div>
    ...
    <script>
        ...
        function resetFilters() {
            ...
            document.getElementById('combinedDivisionFilter').value = '';
            document.getElementById('combinedWinnerFilter').value = '';
            filterTable('combinedTable', 'combinedSearch');
        }
